...
{
    class ScenePlayGameP2 : SceneState
    {
        public ScenePlayGameP2()
        {
            Initialize();
        }

        public SpriteBatchManager playBatchManager;
        public TimeEventManager tInstance;
        public GameObjectNodeManager activeGameManager;
        public CollisionPairManager collisionManager;
        public ShipManager shipManager;
        private DelayObjectManager delayObjManager;
        private GhostManager ghostManager;
        private Font p1ScoreBored;
        ...
        public override void Initialize()
        {
            ...
            GameSession.SetActivePlayer(Player.P2);
            ...
            //UFO
            //TimeEventManager.Add(TimeEvent.Event.UFOEvent, new SpawnUFOEvent(), 15.0f);
        ...
        public override void Entering()
        {
            ...
            this.p1ScoreBored.UpdateMessage(GameSession.p1Score.ToString("0000"));
        ...
        public void InitFonts()
        {
            ...
            this.p1ScoreBored = FontManager.Add(Font.FontName.p1ScoreDisplayP2, SpriteBatchNode.GroupTypes.Text, GameSession.p1Score.ToString("0000"), Glyph.GlyphName.Consolas36pt, 100, 740);
            ...
            FontManager.Add(Font.FontName.p2ScoreDisplayP2, SpriteBatchNode.GroupTypes.Text, GameSession.p2Score.ToString("0000"), Glyph.GlyphName.Consolas36pt, 1000, 740);

            FontManager.Add(Font.FontName.NumLivesLabel, SpriteBatchNode.GroupTypes.Text, "Ship Lives <2>: ", Glyph.GlyphName.Consolas36pt, 0, 15);
            FontManager.Add(Font.FontName.NumLivesP2, SpriteBatchNode.GroupTypes.Text, GameSession.p2NumLives.ToString(), Glyph.GlyphName.Consolas36pt, 300, 15);
        }
        ...
        public override void Handle()
        {
            ...
            else if (GameSession.GetLives(Player.P1) <= 0 && GameSession.GetLives(Player.P2) > 0)
            {
