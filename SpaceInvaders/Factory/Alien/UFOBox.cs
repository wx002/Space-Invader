...
{
    class UFOBox: Composite
    {
        
        public UFOBox(GOName gameObjName, Sprite.SpriteName spriteName, float x, float y) :
            base(gameObjName, spriteName)
        {
            this.name = GOName.UFOBox;
            this.x = x;
            this.y = y;
        ...
        {
            GameObject pGameObj = (GameObject)CompositeIteratorForward.GetChildNode(this);
            CollisionPair.Collide(pGameObj, wallRight);
        }
